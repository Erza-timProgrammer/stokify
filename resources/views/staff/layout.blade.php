         ...
         <ul class="space-y-2 mt-6">
             ...
             <li>
                 ...
                 <ul id="dropdown-sales" class="hidden py-2 space-y-2">
                         <li>
                             <a href="{{ route('staff.menu.transaction') }}" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Transaction</a>
                         </li>
                         <li>
                             <a href="{{ route('staff.menu.opname') }}" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Stock Opname</a>
                         </li>
                         <li>
                             <a href="{{ route('staff.menu.setting') }}" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Stock Setting</a>
                         </li>
                 </ul>
             </li>
                  </ul>
